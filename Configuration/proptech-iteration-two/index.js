...
export default {
    ...
    [
        {
            ...
            latitude: 53.408077,
            longitude: -2.157490,
            narrativeTitle: 'One Stockport: Centre <span hidden id="stage">0</span>',
            narrative: '<p><b>Evolving and expanding the role of the Town Centre</b><br/> '
        ...
        },
        {
            ...
            latitude: 53.408077,
            longitude: -2.157490,
            narrativeTitle: 'One Stockport: Principles <span hidden id="stage">1</span>',
            narrative: '<p><b>Key Areas of Change</b><br/><img src="https://live-iag-static-assets.s3.eu-west-1.amazonaws.com/SmartAnswers/PropTech/Interchange%2Bnew.jpg" altText="image" class="narrativeImg"/>'
        + '<div style="text-align:center; margin-top:10px">'
        ...
        },
	{
            ...
            latitude: 53.408077,
            longitude: -2.157490,
            narrativeTitle: 'One Stockport: Extended <span hidden id="stage">2</span>',
            narrative: '<p><b>A hub for culture and lifestyle</b><br/>'
        + '<div style="text-align:center; margin-top:10px">'
    ...
    {
        key: 3,
        layers:['Town Centre Boundary', 'Borough - 1km', 'Main Town Centre Use Area', 'Primary Shopping Areas', 'District Centres'],
        zoom: 15,
        latitude: 53.408077,
        longitude: -2.157490,
