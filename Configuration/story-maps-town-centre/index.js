...
export default {
        ...
        },
	{
		...
		+ '</ol></p>'
        + '<h2>Explanation</h2>'
        + '<p>The town centre will become the hub of urban living and the town\'s cultural life.'
        + 'We are working with Culture Stockport on ‘The Place That Makes Itself’ strategy, using culture to animate local spaces and promote engagement with the Stockroom project. We will also use funding from the Government to deliver a 3 year programme to transform the town centre into a digital arts neighbourhood.</p>'
        ...
        + '<h2>Explanation</h2>'
        + '<p>We are acting in line with the National Planning Policy Framework (NPPF) to promote the effective use of land in meeting needs for homes and other uses. This involves promoting the development of under-utilised land and buildings and previously developed land.</p>'
        + '<p>We will maximise the capacity of existing urban areas for new development. The Mayoral Development Corporation will help bring forward large-scale generation which will increase market interest and support engagement with the private sector.</p>'
        + '<div style="text-align:center; margin-top:10px">'
    ...
    },
	{
		...
		+ '</ol></p>'
        + '<h2>Explanation</h2>'
        + '<p>We must balance the needs of motorists with the right to clean air and streets. This will involve the removal of through traffic.'
        + 'We will enhance our relationship with the riverfront by creating improved waterfront open spaces, walkways and cycle routes. We will also make environmental improvements such as:'
        + '<ul><li>reducing car dependency and vehicle emissions</li>'
        + '<li>maximising renewable energy sources</li>'
        + '<li>improving use of public realm and natural assets to enhance biodiversity</li>'
        + '<li>prioritising zero carbon construction</li></ul></p>'
        ...
        + '<h2>Explanation</h2>'
        + '<p>Main Town Centre User Area is the name given to the \'Town Centre boundary\' as defined in the National Planning Policy Framework (NPPF).'
        + 'The NPPF requires the specific main town centre uses to be set out. The uses listed in this policy reflect the need to</p>'
        + '<p>The scale of future retail growth will be less than previously expected. This is because of the impact of the recession, growth of internet shopping and changes in spending patterns. The future focus will be on diversifying the town centre\'s offer to attract a wider audience.'
        + 'The prominent locations where environmental improvements would be welcomed include:'
        + '<ul><li>Stockport Station Gateway</li>'
        + '<li>Mersey Square'
        + '<li>Merseyway'
        + '<li>Great Underbank'
        + '<li>A6 Wellington Road South'
        + '<li>Piccadilly area</li></ul>'
        + 'The Primary Shopping Area is concentrated around  around Merseyway, Princes Street, St Petersgate, Warren Street and the Market Place.</p>'
        + '<div style="text-align:center; margin-top:10px">'
        + '<a rel="noreferrer noopener" target=_blank class="govuk-button comment-button" onclick="getNarrativeText();hideShowCommentForm();dialog.show();">Make a comment</a>'
        + '</div>'    
    },
