...
const Configuration = {
  ...
  DynamicData:  
    [
        ...
        {
            key: 'Q2.3 - Pending PRoW application',
            group: 'Q2.3',
            url: 'https://spatial.stockport.gov.uk/geoserver/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=con29:2_3&outputFormat=application/json&bbox={0},EPSG:4326&srsName=EPSG:4326',
            layerOptions: {
                
                style: prowStyle3,
                onEachFeature: prowPopup3
            }
        },

        {
            key: 'Q2.4 - Legal order to stop up, diovert or create a PRoW',
            group: 'Q2.4',
            url: 'https://spatial.stockport.gov.uk/geoserver/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=con29:2_4&outputFormat=application/json&bbox={0},EPSG:4326&srsName=EPSG:4326',
            layerOptions: {
                
                style: prowStyle4,
                onEachFeature: prowPopup4
            }
        },
