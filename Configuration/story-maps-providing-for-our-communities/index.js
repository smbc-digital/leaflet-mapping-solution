...
var stageData = fetch('http://localplan-int.stockport.gov.uk/RetrieveData/ChapterStages?chapterName=story-maps-providing-for-our-communities')
...
export default {
    ...
    [
        ...
        {
            key: 'COM 5 - Sites of strategic significance for outdoor sports',
            //group: groupOneTitle,
            url: 'wms',
            layerOptions: {
                layers: 'local_plan:com3_sites_strategic_significance',
                popup: com3_sites_strategic_significancePopup
            },
            visibleByDefault: false,
            displayInOverlay: false
        },
