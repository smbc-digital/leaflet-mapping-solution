...
var stageData = fetch('https://localhost:44325/RetrieveData/ChapterStages?chapterName=local-plan-town-centre-local')
//var stageData = fetch(retrieveDataEndpoint(window.location.origin, 'local-plan-town-centre-local'));
